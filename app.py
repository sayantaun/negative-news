...
def  final_conclusion(tp,fp, pos_news,subject_name, num_results):
    ...
    conclusion_text_general = "Out of total "+str(num_results)+" news searched, "+"Neg-News-"+str(ctp)+",  Un-related News-"+str(cfp)+",  Non-Neg News-"+str(cpos)+",  Bad URLs-"+str(cbadurl)+" "
...
def main():
    ...
    if st.button('Generate'):
        with st.spinner("Processing"):
            ...
            tab1, tab2, tab3, tab4, tab5 = st.tabs(["Negative News", "Un-related results", "Non-Negative news", "Bad URLs (for manual check)", "Screening Conclusion"])
